# 1 "C:\\Users\\Aluno\\Desktop\\09-12\\quick_sort.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\Users\\Aluno\\Desktop\\09-12\\quick_sort.c"
...
# 2 "C:\\Users\\Aluno\\Desktop\\09-12\\quick_sort.c" 2
...
# 3 "C:\\Users\\Aluno\\Desktop\\09-12\\quick_sort.c" 2

# 1 "C:\\Users\\Aluno\\Desktop\\09-12\\/quick_sort.h" 1
...
# 5 "C:\\Users\\Aluno\\Desktop\\09-12\\quick_sort.c" 2
...
int mediana_de_tres(int * vetor, int esq, int dir)
{
    ...
    if(vetor[dir] < vetor[esq]) {
        troca(vetor + dir, vetor + esq);
    }

    if(vetor[med] < vetor[esq]) {
        troca(vetor + med, vetor + esq);
    }

    if(vetor[dir] < vetor[med]) {
        troca(vetor + dir, vetor + med);
    }
