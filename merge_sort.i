# 1 "C:\\Users\\Aluno\\Desktop\\7_ordenacoes_ordenadas\\merge_sort.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\Users\\Aluno\\Desktop\\7_ordenacoes_ordenadas\\merge_sort.c"
...
# 2 "C:\\Users\\Aluno\\Desktop\\7_ordenacoes_ordenadas\\merge_sort.c" 2
...
# 3 "C:\\Users\\Aluno\\Desktop\\7_ordenacoes_ordenadas\\merge_sort.c" 2

# 1 "C:\\Users\\Aluno\\Desktop\\7_ordenacoes_ordenadas\\/merge_sort.h" 1



void merge_sort(int *vetor, int inicio, int fim, int TAM);
void funde_sort(int *vetor, int *temp, int esq, int meio, int dir, int TAM);
# 5 "C:\\Users\\Aluno\\Desktop\\7_ordenacoes_ordenadas\\merge_sort.c" 2

void merge_sort(int *vetor, int inicio, int fim, int TAM)
{
    if (vetor == ((void *)0)) {
        fprintf((&_iob[2]), "merge_sort: ponteiro inavalido");
        exit(1);
    }
    int meio;
...
{
    if (vetor == ((void *)0)) {
        fprintf((&_iob[2]), "merge_sort->funde_sort: ponteiro inavalido");
        exit(1);
    }
    int i=esq;
    int j=esq;
